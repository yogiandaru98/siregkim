            ...
            <li
                ...
                <ul class="submenu ">
                    <li class="submenu-item ">
                        <a href="pkl.html">Praktik Kerja Lapangan</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="pra-ta.html">Pra-Tugas Akhir 1</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="ta-1.html">Tugas Akhir 1</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="ta-2.html">Tugas Akhir 2</a>
                    </li>
                    <li class="submenu-item ">
                        <a href="kompre.html">Ujian Komprehensif</a>
                    </li>
                </ul>
            </li>            
        </ul>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-borderless mb-0 table-lg">
                                <tr>
                    ...
                    <div class="modal-body">
                        <form action='updateProfile' method="POST">
                            ...
                            <div class="form-floating mb-3">
                              <input type="text" class="form-control ms-1" id="name" name="name" value= "">
                              <label for="name">Nama Lengkap</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control ms-1" id="name" name="npm" value= "">
                                <label for="name">NPM</label>
                              </div>
                            <div class="form-floating mb-3">
                              <input type="date" class="form-control ms-1" id="date" name="date" value="">
