                            ...
                            <tbody>
                                ...
                                foreach ($template as $item) : ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="/berkas/template/<?= $item['file_template'] ?>" target="_blank">Unduh Berkas</a>    
                                        </td>
                                        <td class="align-middle text-center">
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="/template/edit/<?= $item['id_berkas_template_seminar'] ?>" class="btn btn-icon btn-warning mr-5 ml-3"><i class="fas fa-edit"></i></a>
