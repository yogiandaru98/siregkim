        ...
        <div class="row">
            <div class="col-12">
                <div class="card p-3">
                    ...
                    <form action="/mahasiswa/prata/create/action" method="POST" enctype="multipart/form-data">
                        <?php csrf_field(); ?>
                        <div class="form-floating mb-3">
                            <input require type="text" class="form-control <?= ($validation->hasError('judul_prata')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="judul_prata" name="judul_prata" value="<?= set_value('judul_prata'); ?>">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="month" class="form-control <?= ($validation->hasError('periode_seminar_prata')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="month" name="periode_seminar_prata" value="<?= set_value('periode_seminar_prata'); ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="text" class="form-control <?= ($validation->hasError('dosen_pembimbing_prata')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="dosen_pembimbing_prata" name="dosen_pembimbing_prata" value="<?= set_value('dosen_pembimbing_prata'); ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="number" class="form-control <?= ($validation->hasError('nip_pembimbing_prata')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="nip_pembimbing_prata" name="nip_pembimbing_prata" value="<?= set_value('nip_pembimbing_prata'); ?>">
                            <div class="invalid-feedback">
