...
<h1 class="page-title d-flex justify-content-center">Tugas Akhir 2</h1>
                ...
                <div class="card p-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <td style="width: 20% !important;">Judul/Topik Tugas Akhir 2</td>
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><?= $ta2['judul_ta2'] ?></td>

                            </tr>
                            <tr>
                                <td style="width: 20% !important;">Prodi</td>
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><?= $ta2['prodi'] ?></td>

                            </tr>
                            <tr>
                                <td style="width: 20% !important;">Periode Seminar Tugas Akhir 2</td>
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><?= $ta2['periode_seminar_ta'] ?></td>

                            </tr>
                            <tr>
                                <td style="width: 20% !important;">Dosen Pembimbing Akademik</td>
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><?= $ta2['dosen_pembimbing_akademik'] ?></td>

                            </tr>
                            <tr>
                                <td style="width: 20% !important;">NIP Pembimbing Akademik</td>
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><?= $ta2['nip_pembimbing_akademik'] ?></td>

                            </tr>
                            <tr>
                                <td style="width: 20% !important;">SKS</td>
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><?= $ta2['sks'] ?></td>

                            </tr>
                            <tr>
                                <td style="width: 20% !important;">IPK</td>
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><?= $ta2['ipk'] ?></td>

                            </tr>
                            <tr>
                                <td style="width: 20% !important;">Status Registrasi</td>
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><?= $ta2['status_ta2'] ?></td>
                            ...
                            <tr>
                                ...
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;"><a href="/berkas/ta2/<?= $ta2['berkas_kelengkapan'] ?>" target="_blank">Unduh Berkas</a></td>
                            ...
                            <tr>
                                ...
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;">
                                    <?php if ($ta2['status_ta2'] != "Valid") : ?>
                                        Data Anda Belum Di Validasi Oleh Admin
                                    <?php else : ?>
                                        <a href="/berkas/ta2/<?= $ta2['berkas_seminar_ta2'] ?>" target="_blank">Unduh</a>
                                </td>
                            <?php endif; ?>
                        ...
                        <a class="btn btn-primary" href="<?= site_url('/mahasiswa/profile/edit') ?>" data-bs-toggle="modal"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="/mahasiswa/ta2/buktiSeminar" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            <tr>
                                ...
                                <td style="width: 5% !important;">:</td>
                                <td style="width: 75% !important;">
                                <?php if ($ta2['bukti_seminar_ta2']) : ?>
                                <a href="/berkas/ta2/<?= $ta2['bukti_seminar_ta2'] ?>" target="_blank">Unduh</a>
                                <?php else : ?>
