                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="/mahasiswa/pkl/edit/action" method="POST" enctype="multipart/form-data">
                                    <?php csrf_field(); ?>
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="judul_pkl">Judul/Topik PKL</label>
                                                <input required type="text" id="judul_pkl" class="form-control <?= ($validation->hasError('judul_pkl')) ? 'is-invalid' : ''; ?>" placeholder="Judul" name="judul_pkl" value="<?= $pkl['judul_pkl']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="choices form-select" name="dosen_pembimbing_pkl">
                                                    <?php foreach ($dosen as $item) : ?>
                                                        <option value="<?= $item['id_user'] ?>" <?= ($item['id_user']==$pkl['dosen_pembimbing_pkl'])?'selected':'' ?> ><?= $item['nama'] ?> -- <?= $item['username'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" id="pembimbing_lapangan" class="form-control <?= ($validation->hasError('pembimbing_lapangan')) ? 'is-invalid' : ''; ?>" name="pembimbing_lapangan" placeholder="Pembimbing Lapangan" value="<?= $pkl['pembimbing_lapangan']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="number" id="no_pembimbing_lapangan" class="form-control <?= ($validation->hasError('no_pembimbing_lapangan')) ? 'is-invalid' : ''; ?>" name="no_pembimbing_lapangan" placeholder="NIP / NO_KARYAWAN Pembimbing Lapangan" value="<?= $pkl['no_pembimbing_lapangan']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="number" id="toefl" class="form-control <?= ($validation->hasError('toefl')) ? 'is-invalid' : ''; ?>" name="toefl" placeholder="TOEFL" value="<?= $pkl['toefl']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" id="nama_mitra_pkl" class="form-control <?= ($validation->hasError('nama_mitra_pkl')) ? 'is-invalid' : ''; ?>" placeholder="Nama Mitra PKL" name="nama_mitra_pkl" value="<?= $pkl['nama_mitra_pkl']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="number" id="sks" class="form-control <?= ($validation->hasError('sks')) ? 'is-invalid' : ''; ?>" name="sks" placeholder="SKS" value="<?= $pkl['sks']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="month" id="periode_seminar_pkl" class="form-control <?= ($validation->hasError('periode_seminar_pkl')) ? 'is-invalid' : ''; ?>" name="periode_seminar_pkl" placeholder="Rencana Periode Seminar" value="<?= $pkl['periode_seminar_pkl']; ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="number" max="4" step="0.01" id="ipk" class="form-control <?= ($validation->hasError('ipk')) ? 'is-invalid' : ''; ?>" name="ipk" placeholder="IPK" value="<?= $pkl['ipk']; ?>">
                                                <div class="invalid-feedback">
