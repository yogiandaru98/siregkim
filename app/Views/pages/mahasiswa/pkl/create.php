            ...
            <div class="col-12">
                <div class="card p-3">
                    ...
                    <form action="/mahasiswa/pkl/create/action" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="number" class="form-control <?= ($validation->hasError('nip_pembimbing_pkl')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="nip_pembimbing_pkl" name="nip_pembimbing_pkl" value="<?= set_value('nip_pembimbing_pkl'); ?>">
                            <div class="invalid-feedback">
