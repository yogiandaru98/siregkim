        ...
        <div class="row">
            <div class="col-12">
                <div class="card p-3">
                    ...
                    <form action="/mahasiswa/pkl/edit/action" method="POST" enctype="multipart/form-data">
                        <?php csrf_field(); ?>
                        <div class="form-floating mb-3">
                            <input require type="text" class="form-control <?= ($validation->hasError('judul_pkl')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="judul_pkl" name="judul_pkl" value="<?= $pkl['judul_pkl']; ?>">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="month" class="form-control <?= ($validation->hasError('periode_seminar_pkl')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="month" name="periode_seminar_pkl" value="<?= $pkl['periode_seminar_pkl']; ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="text" class="form-control <?= ($validation->hasError('lokasi_pkl')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="lokasi_pkl" name="lokasi_pkl" value="<?= $pkl['lokasi_pkl']; ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="number" class="form-control <?= ($validation->hasError('no_pembimbing_lapangan')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="no_pembimbing_lapangan" name="no_pembimbing_lapangan" value="<?= $pkl['no_pembimbing_lapangan']; ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="number" class="form-control <?= ($validation->hasError('sks')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="sks" name="sks" value="<?= $pkl['sks']; ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-floating mb-3">
                            <input require type="number" max="4" step="0.01" class="form-control <?= ($validation->hasError('ipk')) ? 'is-invalid' : ''; ?> ms-1" autocomplete="off" id="ipk" name="ipk" value="<?= $pkl['ipk']; ?>">
                            <div class="invalid-feedback">
