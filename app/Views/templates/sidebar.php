            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub <?= ($title == "Profile" || $title == "Ganti Password") ? 'active' : '' ?>">
                        ...
                        <li class="sidebar-item  has-sub <?= ($title == "Registrasi" || $title == "Bukti") ? 'active' : '' ?>">
                            ...
                            <ul class="submenu" style="<?= ($title == "Registrasi" || $title == "Bukti") ? 'display: block;' : '' ?>">
                                ...
                                <li class="submenu-item <?= ($title == "Bukti") ? 'active' : '' ?>">
                                    <a href="/validasi/seminar">Bukti Seminar</a>
                                </li>

                            </ul>
                        </li>
                        <li class="sidebar-item <?= ($title == "Kelengkapan") ? 'active' : '' ?> ">
                            <a href="<?= site_url("kelengkapan") ?>" class='sidebar-link'>

                                <i class="bi bi-file-earmark-fill"></i>
                                <span>Berkas Kelengkapan</span>
                            </a>
                        </li>
                        <li class="sidebar-item <?= ($title == "Template") ? 'active' : '' ?> ">
                            <a href="<?= site_url("template") ?>" class='sidebar-link'>

                                <i class="bi bi-file-earmark-word-fill"></i>
                                <span>Template Seminar</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (session()->get('is_koor') == 1) : ?>
                        <li class="sidebar-item <?= ($title == "Lokasi") ? 'active' : '' ?> ">
                            <a href="<?= site_url("lokasi") ?>" class='sidebar-link'>

                                <i class="bi bi-pin-map-fill"></i>
                                <span>Lokasi Seminar</span>
                            </a>
                        </li>
                        <li class="sidebar-item <?= ($title == "Jadwal") ? 'active' : '' ?> ">
                    ...
                    <?php endif; ?>
                    <?php if (session()->get('is_superadmin') == 1) : ?>
                        <li class="sidebar-item <?= ($title == "Tambah Akun") ? 'active' : '' ?> ">
                            <a href="<?= site_url("superadmin/akun") ?>" class='sidebar-link'>
